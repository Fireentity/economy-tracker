...
object TextGenerator {
    ...
    fun generateText(summary: Summary): String {
        ...
        val positivePhrase = positivePhrases.random() + "${String.format(Locale.getDefault(),"%.2f", summary.monthlyPositive)} €.\n"
        val negativePhrase = negativePhrases.random() + "${String.format(Locale.getDefault(),"%.2f", summary.monthlyNegative)} €.\n"
        val totalPhrase = totalPhrases.random() + "${String.format(Locale.getDefault(),"%.2f", summary.monthlyAll)} €.\n"
